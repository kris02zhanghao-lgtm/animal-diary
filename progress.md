...
## 当前状态
🚧 **v0.9「成就系统」已完成开发与技术验收，待浏览器交互验收（2026-05-04）**
...
- ⏳ 待补最终确认：浏览器手动验收成就弹窗、时间窗口切换、多成就连续解锁、物种修正 sheet 和删除反馈交互
...
### v0.9：游戏化完整 + 新用户体验
- [x] **成就系统**：猫色大师、夜行者、老朋友、跨城旅行家、记录狂人；报告页成就区块、详情弹窗、解锁通知已完成开发与技术验收，待浏览器手动验收
- [ ] **图鉴完成度百分比**
  - 预定义城市常见动物清单（分类粒度基于用户认知）
  - 猫细分：橘猫、奶牛猫、狸花猫、黑猫、白猫、三花猫、玳瑁猫、宠物品种
  - 鸟细分：麻雀、鸽子、乌鸦、喜鹊、其他
  - 显示已发现 X/N 种，激发收集动力
- [ ] **新用户引导**：第一次打开的欢迎流程
